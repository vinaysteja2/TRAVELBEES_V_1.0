...
import { AdminComponent } from './adminwithoutOtp/admin/admin.component';
...
//ADMIN-DASHBOARD
{
  ...
  children: [
    ...
    {path:'adminRegister',component:AdminRegisterComponent},
    { path: '', redirectTo: 'adminRegisterwithoutOTP', pathMatch: 'full' },
    {path:'adminRegisterwithoutOTP',component:AdminComponent},
    // { path: 'userLogin', component: UserLoginComponent } ,
